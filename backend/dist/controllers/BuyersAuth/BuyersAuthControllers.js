...
const buyersAuthentication_1 = __importDefault(require("../../models/buyersAuthentication"));
...
const registerBuyer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const BuyerExists = yield buyersAuthentication_1.default.findOne({ email });
        if (BuyerExists)
        ...
        const newBuyer = new buyersAuthentication_1.default({ name, email, phone, company, password: hashedPass, address }); // ✅ Corrected fields
        yield newBuyer.save();
        if (!process.env.JWT_SECRET) {
            throw new Error("JWT_SECRET is missing in environment variables");
        }
        const JWT_SECRET = process.env.JWT_SECRET;
        const token = jsonwebtoken_1.default.sign({ id: newBuyer._id }, JWT_SECRET, { expiresIn: "1h" });
...
const loginBuyer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const UserData = yield buyersAuthentication_1.default.findOne({ email });
        if (!UserData)
